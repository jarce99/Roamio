...
// Theme JavaScript - Main functionality
  ...
  if (productImages.length && mainImage) {
    productImages.forEach(image => {
      image.addEventListener('click', function() {
        ...
        mainImage.srcset = this.dataset.fullsize;
  ...
  if (newsletterForm) {
    newsletterForm.addEventListener('submit', function(e) {
      ...
      .catch(error => {
        ...
        newsletterForm.innerHTML = '<p class="error">Something went wrong. Please try again.</p>';
      });
    });
  }
});
